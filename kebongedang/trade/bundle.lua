...
-- 14 modul, di-generate 2026-09-12T01:09:10.235Z
return {
	["app.lua"] = [=[
...
return function(ctx)
	...
	pcall(function()
		...
		local RECON = ("getgenv().GAG_BRANCH='%s';loadstring(game:HttpGet('https://raw.githubusercontent.com/catursec/testing/%s/kebongedang/init.lua'))()"):format(branch, branch)
...
return function(ctx)
	...
	local ROUTER = "loadstring(game:HttpGet('https://raw.githubusercontent.com/catursec/testing/main/kebongedang/init.lua'))()"
	...
	_G.__AH_SellConn = AddToHistory.OnClientEvent:Connect(function(tx)
		...
		if isSeller and isSuccess then
			...
			sendWebhook({
				...
				avatar_url = "https://raw.githubusercontent.com/catursec/testing/main/kebongedang/Logo/logo_icon.png",
				embeds = { embed }
			})
